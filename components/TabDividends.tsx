      ...
      <div className="bg-white p-3 rounded-lg shadow-sm border border-blue-200 flex flex-col gap-3 flex-none">
          <div className="flex items-center justify-between gap-2 overflow-x-auto no-scrollbar">
              ...
              <div className="flex items-center gap-2 shrink-0 pl-2 border-l border-gray-100">
                 <button className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 text-blue-700 border border-blue-200 rounded-lg hover:bg-blue-100 font-bold text-base whitespace-nowrap shadow-sm"><Megaphone className="w-4 h-4" /> 配息公告</button>
       ...
       <div className="flex-1 flex gap-2 overflow-hidden min-h-0"><div className="flex-1 bg-white p-4 text-gray-400 text-center">除息資訊內容區</div></div>
    </div>
  );
};
