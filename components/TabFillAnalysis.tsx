...
const TabFillAnalysis: React.FC<TabFillAnalysisProps> = ({ 
  ...
  const filteredMaster = useMemo(() => {
      ...
      if (mainFilter !== '全部') {
          ...
          else if (mainFilter === '月配') result = result.filter(d => getStr(d.dividendFreq).includes('月') && !getStr(d.category).includes('債')); // OK for Active
    ...
    <div className="h-full flex flex-col p-2 gap-2 bg-blue-50">
      ...
      <div className="flex-1 flex gap-2 overflow-hidden min-h-0">
          ...
          <div className="w-[340px] flex-none bg-white rounded-lg shadow-sm border border-blue-200 flex flex-col overflow-hidden min-h-0">
              <div className="p-3 bg-blue-50 border-b border-blue-100 font-bold text-blue-900 flex justify-between items-center text-base">
