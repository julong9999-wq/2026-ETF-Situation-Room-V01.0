...
const APP_VERSION = 'V.01.30'; // Internal Logic Version 
const DISPLAY_VERSION = 'V1.24'; // UI Display Version
  ...
  if (isInitializing) {
      return (
          <div className="flex flex-col items-center justify-center h-screen bg-blue-50 text-blue-900">
              ...
              <h2 className="text-2xl font-bold mb-2">系統載入中 (V1.24)...</h2>
              <div className="bg-white/50 px-6 py-4 rounded-xl text-center border border-blue-200 max-w-sm">
                  <p className="text-sm text-blue-800 font-bold mb-1">正在套用 V1.24 更新</p>
                  <p className="text-xs text-blue-600">雙重驗證路徑解析</p>
              </div>
          </div>
      );
  }
