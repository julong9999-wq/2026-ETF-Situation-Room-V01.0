...
const APP_VERSION = 'V.01.27'; // Internal Logic Version 
const DISPLAY_VERSION = 'V1.21'; // UI Display Version
  ...
  if (isInitializing) {
      return (
          <div className="flex flex-col items-center justify-center h-screen bg-blue-50 text-blue-900">
              ...
              <h2 className="text-2xl font-bold mb-2">系統載入中 (V1.21)...</h2>
              <div className="bg-white/50 px-6 py-4 rounded-xl text-center border border-blue-200 max-w-sm">
                  <p className="text-sm text-blue-800 font-bold mb-1">正在套用 V1.21 更新</p>
              </div>
          </div>
      );
  }
